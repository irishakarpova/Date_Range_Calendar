...
export const getAriclesList = createSelector(getAriclesMap, articlesMap => articlesMap.valueSeq().toArray());
...
export const filtratedArticleSelector = createSelector(dayRangeSelector, getAriclesList, (dateRange, articles) => {
  const {
    from,
    to
  } = dateRange;
